document.addEventListener('DOMContentLoaded', () => {
    ...
    for (var i = 0, len = squares.length; i < len; i++) {
        ...
        (function (index) {
            ...
            squares[i].onclick = function () {
                ...
                if (squares[index + 7].classList.contains('taken') && playing === 1) {
                    if (currentPlayer === 1) {
                    ...
                    } else if (currentPlayer === 2 && playing === 1) {
                        squares[index].classList.add('taken')
                    ...
                    alert('Oops! The game has ended! Refresh to play again.')
            }
        })(i)
    }
    ...
    function checkBoard() {
        ...
        for (let y = 0; y < winningArrays.length && playing === 1; y++) {
